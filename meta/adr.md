...
| 0066 | [A quiesce window is guarded by a host-side deadman, not the driver alone](./adr/0066-a-backups-quiesce-window-is-guarded-by-a-host-side-deadman.md)            |
...
| 0070 | [The ssh include is regenerated by the roster write, not by the command](./adr/0070-the-ssh-include-is-regenerated-by-the-roster-write.md)                      |
...
- The Docker daemon's overhead is paid on any Host running a granted exception
