...
- *(navidrome)* bump to 0.64.2 ([#987](https://github.com/espadat-studio/auberge/pull/987))
- *(memsearch)* bump to 0.4.21 ([#986](https://github.com/espadat-studio/auberge/pull/986))
- *(deps)* update github/codeql-action digest to 2892aa5 ([#984](https://github.com/espadat-studio/auberge/pull/984))
- *(deps)* update taiki-e/install-action digest to 45fceba ([#985](https://github.com/espadat-studio/auberge/pull/985))
...
- *(uv)* bump to 0.12.15 ([#921](https://github.com/espadat-studio/auberge/pull/921))
- *(deps)* update taiki-e/install-action digest to e88e69e ([#920](https://github.com/espadat-studio/auberge/pull/920))
- *(opencode)* bump to 1.18.31 ([#918](https://github.com/espadat-studio/auberge/pull/918))
- *(uv)* bump to 0.12.14 ([#919](https://github.com/espadat-studio/auberge/pull/919))
- *(hermes)* bump to v2026.9.14 ([#917](https://github.com/espadat-studio/auberge/pull/917))
- *(deps)* update release-plz/action digest to b8d6b54 ([#916](https://github.com/espadat-studio/auberge/pull/916))
...
- move docs site to auberge.espadat.com ([#857](https://github.com/espadat-studio/auberge/pull/857))

## [0.17.9](https://github.com/sripwoud/auberge/compare/v0.17.8...v0.17.9) - 2026-09-11

### Other

- *(immich)* bump to 3.2.0 ([#855](https://github.com/sripwoud/auberge/pull/855))
...
- *(colporteur)* bump to 0.6.2 ([#843](https://github.com/sripwoud/auberge/pull/843))

## [0.17.5](https://github.com/sripwoud/auberge/compare/v0.17.4...v0.17.5) - 2026-09-07

### Other

- *(bichon)* bump to 2.0.3 ([#841](https://github.com/sripwoud/auberge/pull/841))
...
- *(headscale)* name the 15-minute window when register misses the cache ([#731](https://github.com/sripwoud/auberge/pull/731))

## [0.16.3](https://github.com/sripwoud/auberge/compare/v0.16.2...v0.16.3) - 2026-08-30

### Fixed

- *(headscale)* accept base64url auth ids in register ([#727](https://github.com/sripwoud/auberge/pull/727))

## [0.16.2](https://github.com/sripwoud/auberge/compare/v0.16.1...v0.16.2) - 2026-08-30

### Added

- *(headscale)* register approves a pending interactive enrollment ([#726](https://github.com/sripwoud/auberge/pull/726))

### Other

- *(yourls)* bump to 1.10.6 ([#723](https://github.com/sripwoud/auberge/pull/723))
...
- *(immich)* add role to apps.yml roster
...
- *(yourls)* bootstrap db init via load-yourls.php ([#556](https://github.com/sripwoud/auberge/pull/556))

## [0.15.5](https://github.com/sripwoud/auberge/compare/v0.15.4...v0.15.5) - 2026-08-21

### Fixed

- *(backup)* prompt for restore apps instead of stale hardcoded list ([#553](https://github.com/sripwoud/auberge/pull/553))
...
- *(infrastructure)* normalize locale/timezone and guarantee python3 ([#526](https://github.com/sripwoud/auberge/pull/526))

### Fixed

- *(bootstrap)* default ip prompt to host address and validate input ([#529](https://github.com/sripwoud/auberge/pull/529))
...
- *(backup)* make restic prune actually forget old snapshots ([#372](https://github.com/sripwoud/auberge/pull/372))
...
- *(deps)* bump openssl from 0.10.78 to 0.10.79 in the cargo group across 1 directory ([#322](https://github.com/sripwoud/auberge/pull/322))
...
- *(backup)* keep push/prune running when some apps fail ([#256](https://github.com/sripwoud/auberge/pull/256))
...
- *(paperless)* download NLTK punkt_tab tokenizer during deployment

## [0.7.1](https://github.com/sripwoud/auberge/compare/v0.7.0...v0.7.1) - 2026-03-20

### Fixed

- *(paperless)* download NLTK stopwords corpus during deployment ([#210](https://github.com/sripwoud/auberge/pull/210))

## [0.7.0](https://github.com/sripwoud/auberge/compare/v0.6.17...v0.7.0) - 2026-03-19

### Added

- [**breaking**] remove vdirsyncer role and all related code
...
- *(vdirsyncer)* auto-create Baikal calendar on deploy ([#201](https://github.com/sripwoud/auberge/pull/201))
...
- *(blocky)* resolve Tailscale-bound domains to Tailscale IP via customDNS ([#195](https://github.com/sripwoud/auberge/pull/195))
...
- *(colporteur)* opt-in FreshRSS feed sync on deploy

### Fixed

- *(colporteur)* allow caddy to traverse data directory
...
- *(colporteur)* resolve password commands before writing to secret files ([#165](https://github.com/sripwoud/auberge/pull/165))
...
- correct embedded asset extraction paths ([#155](https://github.com/sripwoud/auberge/pull/155))

## [0.6.1](https://github.com/sripwoud/auberge/compare/v0.6.0...v0.6.1) - 2026-03-12

### Other

- *(colporteur)* bump to `0.3.4`
- include `build` commit type in release trigger
...
- interactively select `dns set` arguments ([#134](https://github.com/sripwoud/auberge/pull/134))

### Fixed

- flatten `Config` struct to match flat TOML format ([#135](https://github.com/sripwoud/auberge/pull/135))

### Other

- remove `zone_id` config option ([#136](https://github.com/sripwoud/auberge/pull/136))
...
- add bichon role for email archiving ([#121](https://github.com/sripwoud/auberge/pull/121))
...
- add PostgreSQL dump/restore and offsite push via `restic` ([#114](https://github.com/sripwoud/auberge/pull/114))
- auto-deploy infrastructure dependencies when deploying apps ([#113](https://github.com/sripwoud/auberge/pull/113))
- validate required config before ansible execution ([#112](https://github.com/sripwoud/auberge/pull/112))
- *(cli)* add shorthand aliases for all subcommands ([#111](https://github.com/sripwoud/auberge/pull/111))
- configure Tailscale DNS to use Blocky ([#107](https://github.com/sripwoud/auberge/pull/107))

### Other

- extract `SshSession` struct to eliminate SSH arg duplication ([#116](https://github.com/sripwoud/auberge/pull/116))
- remove unused namecheap config and restructure sections ([#109](https://github.com/sripwoud/auberge/pull/109))
