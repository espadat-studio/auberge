...
| Error                        | Cause                                | Fix                                                                                                     |
| ---------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| `"Unreachable"`              | SSH connectivity failure             | See [SSH Problems](/troubleshooting/ssh-problems/)                                                      |
...
Causes: Cloudflare API token wrong, DNS not pointing to VPS, port 80/443 blocked. See [DNS Issues](/troubleshooting/dns-issues/).
