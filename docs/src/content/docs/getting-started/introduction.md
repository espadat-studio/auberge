...
**Networking**: [Blocky](https://0xerr0r.github.io/blocky), [Headscale](https://headscale.net), [Tailscale](https://tailscale.com)

**Apps**: [Actual Budget](https://actualbudget.org), [Baikal](https://sabre.io/baikal), [Bichon](https://github.com/rustmailer/bichon), [Grimmory](https://grimmory.org), [Colporteur](https://github.com/espadat-studio/colporteur), [FreshRSS](https://freshrss.org), [Gokapi](https://github.com/Forceu/Gokapi), [Navidrome](https://navidrome.org), [Paperless-ngx](https://docs.paperless-ngx.com), [Syncthing](https://syncthing.net), [YOURLS](https://yourls.org)
